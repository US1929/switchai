      ...
      <div style={{
        ...
        {isVariable && (
          <div style={{
            ...
            ⚡ La tua tariffa è variabile: la spesa mostrata è una proiezione basata sul {isLuce ? 'PUN' : 'PSV'} attuale.
            Un'offerta a prezzo fisso ti protegge da aumenti futuri.
          </div>
        )}
      </div>
    </div>
